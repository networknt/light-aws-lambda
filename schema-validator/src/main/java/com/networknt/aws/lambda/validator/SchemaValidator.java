...
public class SchemaValidator {
    ...
    public SchemaValidator(final OpenApi3 api) {
        ...
        this.pathType = PathType.JSON_POINTER;
    }
    ...
    public Status validate(final JsonNode value, final JsonNode schema, boolean typeLoose,
        ...
        return doValidate(value, schema, typeLoose, nullableKeywordEnabled, pathType, null);
    }
    ...
    private Status doValidate(final JsonNode value, final JsonNode schema, boolean typeLoose,
        ...
        try {
            ...
            LOG.error("Unable to validate the value against the OpenAPI schema", e);
    ...
    private SchemaRegistry getRegistry(boolean typeLoose, boolean nullableKeywordEnabled,
