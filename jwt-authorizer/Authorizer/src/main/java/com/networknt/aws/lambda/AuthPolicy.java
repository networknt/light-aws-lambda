...
public class AuthPolicy {
    ...
    public static class PolicyDocument {
        ...
        public void allowMethod(HttpMethod httpMethod, String resourcePath) {
            Statement allowStatement = Statement.getEmptyInvokeStatement("Allow");
            statements.add(allowStatement);
            setResourceToStatement(allowStatement, httpMethod, resourcePath);
        }

        public void denyMethod(HttpMethod httpMethod, String resourcePath) {
            Statement denyStatement = Statement.getEmptyInvokeStatement("Deny");
            statements.add(denyStatement);
            setResourceToStatement(denyStatement, httpMethod, resourcePath);
        }
        ...
        private void setResourceToStatement(Statement statement, HttpMethod httpMethod, String resourcePath) {
    ...
    static class Statement {
        ...
        public static Statement getEmptyInvokeStatement(String effect) {
            return new Statement(effect, "execute-api:Invoke", null);
        }
